...
class Pong:
    ...
    def draw(self):
        ...
        if abs(self.paddle1_pos[1] - self.r_hand[1]) > 40:
            if self.paddle1_pos[1] < self.r_hand[1]:
                self.paddle1_pos[1] += 30
            elif self.paddle1_pos[1] > self.r_hand[1]:
                self.paddle1_pos[1] -= 30

        if abs(self.paddle2_pos[1] - self.l_hand[1]) > 40:
            if self.paddle2_pos[1] < self.l_hand[1]:
                self.paddle2_pos[1] += 30
            elif self.paddle2_pos[1] > self.l_hand[1]:
                self.paddle2_pos[1] -= 30
